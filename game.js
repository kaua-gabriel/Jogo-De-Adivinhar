...
function updateVisitCount() {
    ...
    if (visitCount === null) {
        visitCount = 0; // Se não houver valor, começa em 0
    }

    // Incrementa o contador de visitas apenas quando o valor for recuperado
    visitCount++;
...
resetButton.addEventListener('click', resetVisitCount);